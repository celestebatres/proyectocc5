...
// Crear consulta y guardarla en variables para mostrar == en selects trabajar con id's
...
<body>
    <nav class="navbar navbar-expand-lg bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand text-light" href="#">Actualizar Inmueble</a>
        </div>
    ...
    <div class="d-flex justify-content-center align-items-center vh-200 my-3">
        <form name="datos" method="POST" action="inmueble_insert.php">
            <b>
                <p class="fs-4 text-center my-2">Actualizar Inmueble #<?php echo($id)?></p>
            </b>
            <div class="mb-4">

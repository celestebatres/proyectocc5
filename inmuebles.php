...
<body>
    ...
    <div class="content">
        ...
        <div class="card-body">
            ...
            <a href="javascript:fun_update(' . $inmueble . ');" class="btn btn-warning" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
    ...
    ';
        ...
        <form name='fupdate' method='post' action='inmueble_update.php'>
            <input type="hidden" name="id">
        </form>
        <form name='fdelete' method='post' action='inmueble_delete.php'>
            <input type="hidden" name="id">
        </form>
</body>
</html>
